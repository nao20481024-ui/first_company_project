export const sohujiCopy = {
  brand: {
    name: 'Tokyoai',
    tagline:
      'Tokyoai is a software engineering studio focused on production AI systems, workflow automation, and operator-facing products.',
    footerLine:
    ...
    copyright: (year: number) =>
      `© ${year} Tokyoai. All rights reserved.`,
  },
  meta: {
    description:
      'Tokyoai builds production LLM systems, agentic AI workflows, RAG pipelines, and automation platforms with observability, security, and release discipline.',
  },
  nav: {
    home: 'Home',
  ...
  home: {
    ...
    studio: {
      ...
      description:
        'Tokyoai is a software studio that ships full-stack applications, production LLM systems, and workflow automation. Our work is scoped to measurable outcomes, with staging paths, rollback plans, and runbooks included from day one.',
      bullets: [
    ...
    items: [
      {
        ...
        description:
          'Engagements map to metrics you already instrument—MTTR, lead velocity, cost-to-serve, cycle time—so agent and workflow work is justified by production signals, not narrative alone.',
      },
      {
      ...
      },
      {
        ...
        description:
          'One accountable team ships operator UI and the integration layer together—tighter feedback loops from first tool spec to a workflow your team runs daily.',
      },
    ],
  },
  capabilities: {
